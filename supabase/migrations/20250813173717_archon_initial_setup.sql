...
('CODE_SUMMARY_MAX_WORKERS', '3', false, 'code_extraction', 'Maximum parallel workers for code summarization (1-10)'),
...
COMMENT ON COLUMN archon_document_versions.change_summary IS 'Human-readable description of changes';
...
FEATURE_SPEC → body must include
    •    Epic
    •    User_Stories                      // list of { id, as_a, i_want, s... [truncated]'
,'Document builder agent system prompt for creating structured documentation in the docs table'),
